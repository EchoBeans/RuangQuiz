...
Public Class FormQuizPelajar
    ...
    Private Sub FormQuizPelajar_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        TampilData()
        AturLabelUser()
    End Sub
    ...
    Public Sub TampilData()
        bukaKoneksi()
        Try
            Dim da As New MySqlDataAdapter("SELECT * FROM quiz", conn)
        ...
        Catch ex As Exception
            MsgBox("Gagal menampilkan data quiz: " & ex.Message, vbCritical)
        Finally
            tutupKoneksi()
        End Try
    End Sub
    ...
    Private Sub DataGridView1_CellDoubleClick(sender As Object, e As DataGridViewCellEventArgs) Handles DataGridView1.CellDoubleClick
        If e.RowIndex >= 0 Then
            Dim link As String = DataGridView1.Rows(e.RowIndex).Cells("linkquiz").Value.ToString()
            ...
            If link <> "" Then
                Try
                    ...
                    Process.Start(link)
                Catch ex As Exception
                    MsgBox("Gagal membuka link quiz: " & ex.Message, vbCritical)
                End Try
            Else
                MsgBox("Data ini tidak memiliki link quiz.", vbExclamation)
            End If
        End If
    End Sub
    ...
    Private Sub buttonAkses_Click(sender As Object, e As EventArgs) Handles buttonAkses.Click
        If DataGridView1.CurrentRow IsNot Nothing Then
            Dim link As String = DataGridView1.CurrentRow.Cells("linkquiz").Value.ToString()
            ...
            If link <> "" Then
                ...
                End Try
            Else
                MsgBox("Quiz ini tidak memiliki link.", vbExclamation)
            End If
        Else
            MsgBox("Pilih quiz terlebih dahulu.", vbExclamation)
        End If
    End Sub
    ...
    Private Sub textBoxUsername_TextChanged(sender As Object, e As EventArgs) Handles textBoxSearch.TextChanged
        ...
        Try
            ...
            Else
                query = "SELECT * FROM quiz WHERE judul_quiz LIKE @keyword OR deskripsi_quiz LIKE @keyword"
            End If
