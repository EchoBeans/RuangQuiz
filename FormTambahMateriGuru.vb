...
Public Class FormTambahMateriGuru
    ...
    Private Sub buttonTambah_Click(sender As Object, e As EventArgs) Handles buttonTambah.Click
        ...
        bukaKoneksi()
        Try
            Dim query As String = "INSERT INTO materi (judul, deskripsi, link) VALUES (@j, @d, @l)"
            ...
            MsgBox("Data materi berhasil ditambahkan.", vbInformation)
        ...
        Catch ex As Exception
            MsgBox("Gagal menambah data: " & ex.Message, vbCritical)
        Finally
            tutupKoneksi()
        End Try
    End Sub
    ...
    Private Sub FormTambahMateriGuru_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        AturLabelUser()
    End Sub
End Class